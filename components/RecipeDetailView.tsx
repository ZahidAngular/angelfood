...
/** The full recipe layout — shared by the pre-built static pages (fast first
 * paint, then refreshed with live data) and the client-only fallback page
 * used for recipes that don't have a static file yet. */

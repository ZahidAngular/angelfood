  ...
  return (
    <>
      ...
      >
        ...
        >
          <a href="#top" aria-label="Angel Food — home" className="flex items-center">
            <Image
              src="/images/logo.png"
              alt="Angel Food"
              width={120}
          ...
          >
            {NAV_LINKS.map((l) => (
              <a
                key={l.href}
                href={l.href}
                className={`group relative font-medium text-ink-soft transition-all duration-500 hover:text-green ${
